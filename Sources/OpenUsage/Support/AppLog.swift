...
enum AppLog {
    ...
    static func bootstrap() {
        ...
        #else
        // `abbreviatingWithTildeInPath` is unavailable in swift-corelibs Foundation; abbreviate the
        // home prefix ourselves so the startup line stays compact.
        let rawPath = LogFile.url.path
