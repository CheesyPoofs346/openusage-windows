...
struct URLSessionHTTPClient: HTTPClient {
    ...
    private static let loopbackSession: URLSession = {
        ...
        #else
        // No SecTrust-based self-signed handling on this platform; the loopback HTTPS server is a
        // macOS-only feature, so a plain ephemeral session is sufficient for the Windows CLI.
