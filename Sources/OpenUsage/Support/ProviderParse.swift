...
enum ProviderParse {
    ...
    static func number(_ value: Any?) -> Double? {
        if let number = value as? NSNumber {
            // `JSONSerialization` bridges JSON booleans as a Bool-typed NSNumber (objCType "c") on both
            // Apple and swift-corelibs Foundation; reject those so `true`/`false` never become `1`/`0`.
