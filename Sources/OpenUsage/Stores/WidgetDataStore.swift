    ...
    init(
        ...
        self.postNotification = postNotification
            ?? { idPrefix, title, subtitle, body in
                ...
                return await AppNotifications.shared.post(idPrefix: idPrefix, title: title, subtitle: subtitle, body: body)
                #else
                // No user-notification center on this platform (the Windows CLI never posts alerts).
                return false
                #endif
            }
